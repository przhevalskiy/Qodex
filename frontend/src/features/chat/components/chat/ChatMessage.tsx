...
const intentDescriptions: Record<string, string> = {
  ...
  create_case: 'Builds a full case study document from scratch using attached reference material. Extended output with narrative prose across all standard case sections.',
