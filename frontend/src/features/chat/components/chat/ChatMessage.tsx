...
const intentDescriptions: Record<string, string> = {
  ...
  case_study: 'Analyzes existing source material framed as a case — context, stakeholders, challenge, evidence, outcomes. All claims grounded in sources.',
...
const allIntents = [
  ...
  { key: 'case_study', label: 'Case Analysis', desc: 'Analyzes existing sources as a case' },
